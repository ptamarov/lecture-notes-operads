...
where the tensor product in the exponent is
...
$$\lambda = (2,1,2), \quad \sigma = 312
	...
	$$
	$$
	(213,213,132)\in S_3\times S_3\times S_3 \quad 
	\leadsto \quad 213546798\in S_9 $$
...
satisfies $\gamma(1_V;g) = g$ and 
$\gamma(g;1_V,\ldots,1_V) = g$ for every $g\in\End_V$.
\end{tenumerate}
...
to $\sigma$.
\item \emph{Unitality:} the identity $1_V\in\End_V(1)$
satisfies $1_V\circ_1 g = g$ and $g\circ_i 1_V = g$ 
for every $g\in\End_V$ and $1\leqslant i\leqslant \ari(g)$.
\end{tenumerate}
...
\]
 ...
 \longrightarrow \XX({}^\sigma\pi)\otimes \YY[{}^\sigma\pi]$. 
 The resulting map is obtained
